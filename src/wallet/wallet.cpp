        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Crypton: Disable free transactions
...
{
    // Crypton: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Crypton: Add an increased fee for each dust output
        nFeeNeeded += GetCryptonDustFee(tx.vout, minTxFee);
    }
