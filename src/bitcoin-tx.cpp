...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Crypton Core crypton-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  crypton-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crypton transaction") + "\n" +
              "  crypton-tx [options] -create [commands]   " + _("Create hex-encoded crypton transaction") + "\n" +
              "\n";
