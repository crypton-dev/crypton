...
// Copyright (c) 2014-2015 The Crypton Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Crypton Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Crypton: load fallback font in case Comic Sans is not availble on the system
    ...
    // Crypton: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Crypton: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Crypton address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crypton: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Crypton Core"), this);
    aboutAction->setStatusTip(tr("Show information about Crypton Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Crypton Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Crypton addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Crypton addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Crypton Core help message to get a list with possible Crypton command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Crypton Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Crypton"); // default title
