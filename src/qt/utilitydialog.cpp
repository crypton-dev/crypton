    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Crypton Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Crypton Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  crypton-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Crypton Core is shutting down...") + "<br /><br />" +
