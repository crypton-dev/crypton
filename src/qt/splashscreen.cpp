    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceCRN = 40;
    ...
    QString titleText       = tr("Crypton Core");
    ...
    QString copyrightTextCRN  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Crypton Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceCRN,copyrightTextCRN);
