...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MCRN");
    case kBTC: return QString("kCRN");
    case BTC: return QString("CRN");
    case mBTC: return QString("mCRN");
    case uBTC: return QChar(0x03BC) + QString("CRN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Cryptons (1,000,000)");
    case kBTC: return tr("Kilo-Cryptons (1,000)");
    case BTC: return tr("Cryptons");
    case mBTC: return tr("Milli-Cryptons (1 / 1,000)");
    case uBTC: return tr("Micro-Cryptons (1 / 1,000,000)");
    default: return QString("???");
    }
}
